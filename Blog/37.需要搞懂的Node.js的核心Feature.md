...
![](http://m03s6dh33i0jtc3uzfml36au.wpengine.netdna-cdn.com/wp-content/uploads/node-events.png)
...
![](http://webapplog.com/wp-content/uploads/node-buffer.png)

只有整个Buffer加载完后才能进行下一步操作，看图对比下Node的Stream，只要拿到数据的第一个 chunk 就可以进行处理了

![](http://webapplog.com/wp-content/uploads/node-streams.png)
